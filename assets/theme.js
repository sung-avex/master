$(".btn.edit-address").click(function() {
  ...
  $(this)
    .parents("td")
    .siblings(".address-edit")
    .show();
  $(this)
    .siblings(".btn.edit-address-cancel")
    .show();
  $(this)
    .siblings(".btn.edit-address-submit")
    .show();
  $(this)
    .siblings(".btn.delete-address")
    .hide();
  $(this)
    .parents("td")
    .siblings(".address-record")
    .hide();
});
